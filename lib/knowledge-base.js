...
function addKnowledgeBaseCategoryPages (pages, contentCatalog) {
  ...
  for (const [category, pages] of Object.entries(pagesPerCategory)) {
    contentCatalog.addFile(createKnowledgeBaseCategoryPage(category, pages))
  }
}
...
function addKnowledgeBaseTagPages (pages, contentCatalog) {
  ...
  for (const [tag, pages] of Object.entries(pagesPerTag)) {
    contentCatalog.addFile(createKnowledgeBaseTagPage(tag, pages))
  }
}
